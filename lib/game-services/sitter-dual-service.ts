    ...
    const session = await prisma.sitterSession.create({
      data: {
        ...
        permissionSnapshot: {
          ...
          canDemolishBuildings: (sitRel as any).canDemolishBuildings,
          canRecallReinforcements: (sitRel as any).canRecallReinforcements,
          canLaunchConquest: (sitRel as any).canLaunchConquest,
          canDismissTroops: (sitRel as any).canDismissTroops,
        },
